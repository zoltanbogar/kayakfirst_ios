...
func startTrainingViewController(viewController: UIViewController, plan: Plan?, event: Event?, trainingEnvType: TrainingEnvironmentType) {
    let trainingVc = TrainingViewControllerOld()
...
class TrainingViewControllerOld: PortraitNavController, StartDelayDelegate, CalibrationDelegate, OnBluetoothConnectedListener {
